...
foreach ($alumni as $data) {
    ...
    if ($statusAktif && $lamaKelulusan <= 5) {
        echo "<p>$namaAlumni adalah alumni aktif yang lulus dalam 5 tahun terakhir.</p>";
} elseif ($statusAktif && $lamaKelulusan > 5){
    echo "<p>$namaAlumni adalah alumni aktif yang lulus lebih dari 5 tahun yang lalu.</p>";
} elseif (!$statusAktif && $lamaKelulusan <= 5) {
    echo "<p>$namaAlumni adalah alumni tidak aktif yang lulus dalam 5 tahun terakhir.</p>";
} else {
    echo "<p>$namaAlumni adalah alumni tidak aktif yang lulus lebih dari 5 tahun yang lalu.</p>";
}
